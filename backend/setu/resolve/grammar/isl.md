...
These rules drive `backend/setu/resolve/isl_rules.py` and are pasted verbatim into the LLM
prompt when `SETU_SIGN_RESOLVER=llm`. Edit this file, not the code, when a rule
