"""Terminal harness for the live sign -> text layer (no webcam, no browser).
    ...
    python -m setu.perceive.simulate "I went to the bank yesterday."
    python -m setu.perceive.simulate "My mother is sick" --severity 0.8 --seed 3
    python -m setu.perceive.simulate --gloss ME,RIVER,GO --answer RIVER        # repair flow
    python -m setu.perceive.simulate --gloss MY,NAME,DEMO-NAMESIGN              # unknown sign -> hold
    python -m setu.perceive.simulate --teach Kushagra --gloss MY,NAME,DEMO-NAMESIGN   # teach, then use it
    python -m setu.perceive.simulate "What is your name?" --lang hi --lefty
"""
...
def main():
    ...
    ap.add_argument("--data", default="", help="memory directory (default: SETU_DATA or ./data)")
