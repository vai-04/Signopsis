// SIGNOPSIS 3D avatar rig: pure math, no rendering (so it runs in Node tests too).
//
...
import { Object3D, Vector3, Quaternion, Matrix4, MathUtils } from "three";
...
export function makeSpaceMapper(frame) {
  // Same idea as the backend perceive/landmarks.py: shoulders define the signing space.
