// node tests/js/avatar.test.mjs <plan.json>  -- builds the 3D avatar headlessly and plays a real SIGNOPSIS plan
import assert from "node:assert/strict";
import { readFileSync } from "node:fs";
import { Vector3 } from "../../signopsis/serve/static/lib/three-bundle.min.js";
import { createAvatar } from "../../signopsis/serve/static/avatar3d/avatar.js";
import { signingToWorld, lerpParams } from "../../signopsis/serve/static/avatar3d/rig.js";
