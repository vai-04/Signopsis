"""Build a single-file offline demo of the viewer with precomputed results.
    ...
    python -m signopsis.serve.build_demo            # -> dist/signopsis_text2sign_demo.html
"""
...
from signopsis.serve.main import STATIC, sign_clip
...
def build(out: Path = Path("dist/signopsis_text2sign_demo.html")) -> Path:
    results, clips = {}, {}
    ...
    html = html.replace("<script>\n/* ---", f"<script>window.SIGNOPSIS_DEMO={payload};</script>\n<script>\n/* ---", 1)
