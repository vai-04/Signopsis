...
def _load_recognizer():
    from signopsis.perceive.recognizer import base_prototypes
    return base_prototypes()


def _load_roundtrip():
    from signopsis.generate.roundtrip import template_bank
    return template_bank("sign"), template_bank("letter")


def _load_trust():
    from signopsis.fuse.trust import TrustModel
    return TrustModel()
