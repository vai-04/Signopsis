"""Terminal test harness for pipeline D (no browser needed).
    ...
    python -m signopsis.cli "I went to the bank yesterday."
    python -m signopsis.cli "mujhe kal bank jaana hai" --resolve 1=TOMORROW
    python -m signopsis.cli "What is your name?" --gif out.gif      # pixel GIF (needs Pillow)
    python -m signopsis.cli --json "Do you want water?"             # full contracts
"""
