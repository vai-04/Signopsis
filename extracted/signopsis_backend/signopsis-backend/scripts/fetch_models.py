...
Writes into signopsis/serve/static/vendor/ (git-ignored):
...
Python camera client (signopsis.perceive.camera_cv) uses the same model files.
"""
...
ROOT = Path(__file__).resolve().parents[1] / "signopsis" / "serve" / "static" / "vendor"
TV_VERSION = "1.0.1"
